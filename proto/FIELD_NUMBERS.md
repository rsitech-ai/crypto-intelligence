...
| `cmti.risk.v1.CuspBranchProbability` | `branch` | 1 | Active |
| `cmti.risk.v1.CuspBranchProbability` | `probability_ppm` | 2 | Active |
| `cmti.risk.v1.CuspEquilibrium` | `condition_proxy` | 4 | Active |
| `cmti.risk.v1.CuspEquilibrium` | `hessian` | 6 | Active |
| `cmti.risk.v1.CuspEquilibrium` | `multiplicity` | 2 | Active |
| `cmti.risk.v1.CuspEquilibrium` | `residual` | 3 | Active |
| `cmti.risk.v1.CuspEquilibrium` | `restoring_force` | 7 | Active |
| `cmti.risk.v1.CuspEquilibrium` | `root` | 1 | Active |
| `cmti.risk.v1.CuspEquilibrium` | `stability` | 5 | Active |
| `cmti.risk.v1.CuspFeatureSensitivity` | `alpha_sensitivity` | 3 | Active |
| `cmti.risk.v1.CuspFeatureSensitivity` | `beta_sensitivity` | 4 | Active |
| `cmti.risk.v1.CuspFeatureSensitivity` | `feature_id` | 1 | Active |
| `cmti.risk.v1.CuspFeatureSensitivity` | `feature_version` | 2 | Active |
| `cmti.risk.v1.CuspFoldState` | `condition_number` | 8 | Active |
| `cmti.risk.v1.CuspFoldState` | `converged` | 5 | Active |
| `cmti.risk.v1.CuspFoldState` | `distance` | 1 | Active |
| `cmti.risk.v1.CuspFoldState` | `evaluations` | 7 | Active |
| `cmti.risk.v1.CuspFoldState` | `fold_parameter` | 4 | Active |
| `cmti.risk.v1.CuspFoldState` | `iterations` | 6 | Active |
| `cmti.risk.v1.CuspFoldState` | `nearest_alpha` | 2 | Active |
| `cmti.risk.v1.CuspFoldState` | `nearest_beta` | 3 | Active |
| `cmti.risk.v1.CuspGateCheck` | `kind` | 1 | Active |
| `cmti.risk.v1.CuspGateCheck` | `maximum` | 5 | Active |
| `cmti.risk.v1.CuspGateCheck` | `minimum` | 4 | Active |
| `cmti.risk.v1.CuspGateCheck` | `observed` | 3 | Active |
| `cmti.risk.v1.CuspGateCheck` | `passed` | 2 | Active |
| `cmti.risk.v1.CuspGateCheck` | `unit` | 6 | Active |
| `cmti.risk.v1.CuspMissingFeature` | `feature_id` | 1 | Active |
| `cmti.risk.v1.CuspMissingFeature` | `feature_version` | 2 | Active |
| `cmti.risk.v1.CuspMissingFeature` | `reason` | 3 | Active |
| `cmti.risk.v1.CuspServiceGetCuspHistoryRequest` | `asset` | 1 | Active |
| `cmti.risk.v1.CuspServiceGetCuspHistoryRequest` | `before_as_of_time` | 3 | Active |
| `cmti.risk.v1.CuspServiceGetCuspHistoryRequest` | `limit` | 2 | Active |
| `cmti.risk.v1.CuspServiceGetCuspHistoryResponse` | `cusp_states` | 1 | Active |
...
| `cmti.risk.v1.CuspState` | `as_of_time` | 7 | Active |
| `cmti.risk.v1.CuspState` | `asset` | 6 | Active |
| `cmti.risk.v1.CuspState` | `availability` | 5 | Active |
| `cmti.risk.v1.CuspState` | `availability_reason` | 31 | Active |
| `cmti.risk.v1.CuspState` | `beta` | 3 | Active |
| `cmti.risk.v1.CuspState` | `branch_probabilities` | 14 | Active |
| `cmti.risk.v1.CuspState` | `cusp_region_probability` | 9 | Active |
| `cmti.risk.v1.CuspState` | `equilibria` | 12 | Active |
| `cmti.risk.v1.CuspState` | `evidence_blake3` | 21 | Active |
| `cmti.risk.v1.CuspState` | `feature_coverage_ppm` | 26 | Active |
| `cmti.risk.v1.CuspState` | `fold` | 28 | Active |
| `cmti.risk.v1.CuspState` | `fold_distance` | 4 | Active |
| `cmti.risk.v1.CuspState` | `gate_checks` | 33 | Active |
| `cmti.risk.v1.CuspState` | `gate_evaluation_schema_version` | 35 | Active |
| `cmti.risk.v1.CuspState` | `gate_evidence_blake3` | 24 | Active |
| `cmti.risk.v1.CuspState` | `gate_policy_schema_version` | 34 | Active |
| `cmti.risk.v1.CuspState` | `hysteresis` | 17 | Active |
| `cmti.risk.v1.CuspState` | `minimum_barrier` | 15 | Active |
| `cmti.risk.v1.CuspState` | `missing_optional_features` | 19 | Active |
| `cmti.risk.v1.CuspState` | `model_evidence_blake3` | 32 | Active |
| `cmti.risk.v1.CuspState` | `most_likely_branch` | 13 | Active |
| `cmti.risk.v1.CuspState` | `normalized_state` | 8 | Active |
| `cmti.risk.v1.CuspState` | `posterior_sample_count` | 29 | Active |
| `cmti.risk.v1.CuspState` | `production_use` | 23 | Active |
| `cmti.risk.v1.CuspState` | `quality` | 25 | Active |
| `cmti.risk.v1.CuspState` | `restoring_force` | 16 | Active |
| `cmti.risk.v1.CuspState` | `schema_version` | 30 | Active |
| `cmti.risk.v1.CuspState` | `sensitivities` | 18 | Active |
| `cmti.risk.v1.CuspState` | `signed_discriminant` | 10 | Active |
| `cmti.risk.v1.CuspState` | `source_health` | 27 | Active |
| `cmti.risk.v1.CuspState` | `standardized_discriminant` | 11 | Active |
| `cmti.risk.v1.CuspState` | `state_id` | 1 | Active |
| `cmti.risk.v1.CuspState` | `uncertainty_quality` | 20 | Active |
| `cmti.risk.v1.CuspState` | `weight_eligibility` | 22 | Active |
...
| `cmti.risk.v1.CuspBranch` | `CUSP_BRANCH_LOWER` | 1 | Active |
| `cmti.risk.v1.CuspBranch` | `CUSP_BRANCH_UNSPECIFIED` | 0 | Active |
| `cmti.risk.v1.CuspBranch` | `CUSP_BRANCH_UPPER` | 2 | Active |
| `cmti.risk.v1.CuspEquilibriumStability` | `CUSP_EQUILIBRIUM_STABILITY_MARGINAL` | 3 | Active |
| `cmti.risk.v1.CuspEquilibriumStability` | `CUSP_EQUILIBRIUM_STABILITY_STABLE` | 1 | Active |
| `cmti.risk.v1.CuspEquilibriumStability` | `CUSP_EQUILIBRIUM_STABILITY_UNSPECIFIED` | 0 | Active |
| `cmti.risk.v1.CuspEquilibriumStability` | `CUSP_EQUILIBRIUM_STABILITY_UNSTABLE` | 2 | Active |
| `cmti.risk.v1.CuspHysteresisState` | `CUSP_HYSTERESIS_STATE_FOLLOWING_LOWER` | 1 | Active |
| `cmti.risk.v1.CuspHysteresisState` | `CUSP_HYSTERESIS_STATE_FOLLOWING_UPPER` | 2 | Active |
| `cmti.risk.v1.CuspHysteresisState` | `CUSP_HYSTERESIS_STATE_JUMPED_LOWER_TO_UPPER` | 3 | Active |
| `cmti.risk.v1.CuspHysteresisState` | `CUSP_HYSTERESIS_STATE_JUMPED_UPPER_TO_LOWER` | 4 | Active |
| `cmti.risk.v1.CuspHysteresisState` | `CUSP_HYSTERESIS_STATE_UNSPECIFIED` | 0 | Active |
| `cmti.risk.v1.CuspProductionUse` | `CUSP_PRODUCTION_USE_NOT_USED_IN_PRODUCTION_PROBABILITY` | 1 | Active |
| `cmti.risk.v1.CuspProductionUse` | `CUSP_PRODUCTION_USE_UNSPECIFIED` | 0 | Active |
| `cmti.risk.v1.CuspProductionUse` | `CUSP_PRODUCTION_USE_USED_IN_PRODUCTION_PROBABILITY` | 2 | Active |
| `cmti.risk.v1.CuspUncertaintyQuality` | `CUSP_UNCERTAINTY_QUALITY_EXPERIMENTAL` | 2 | Active |
| `cmti.risk.v1.CuspUncertaintyQuality` | `CUSP_UNCERTAINTY_QUALITY_PRODUCTION_CANDIDATE` | 1 | Active |
| `cmti.risk.v1.CuspUncertaintyQuality` | `CUSP_UNCERTAINTY_QUALITY_UNAVAILABLE` | 3 | Active |
| `cmti.risk.v1.CuspUncertaintyQuality` | `CUSP_UNCERTAINTY_QUALITY_UNSPECIFIED` | 0 | Active |
| `cmti.risk.v1.CuspWeightEligibility` | `CUSP_WEIGHT_ELIGIBILITY_ELIGIBLE_FOR_PRODUCTION_WEIGHT` | 2 | Active |
| `cmti.risk.v1.CuspWeightEligibility` | `CUSP_WEIGHT_ELIGIBILITY_RESEARCH_ONLY` | 1 | Active |
| `cmti.risk.v1.CuspWeightEligibility` | `CUSP_WEIGHT_ELIGIBILITY_UNSPECIFIED` | 0 | Active |
